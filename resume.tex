...
\begin{technicalskills}
    \techskill{\regcol{Languages}}{
        Python, \ R, \ C++, \ Scala, \ SQL (Oracle), \ NoSQL (MongoDB, HBase), \ Shell (BASH)
    }
    ...
    \techskill{\regcol{(continued)}}{
        Spark, \ Hadoop, \ AWS (Elastic MapReduce, \ Sagemaker, \ S3), \ Flask, \ unittest/Mockito
    }
\end{technicalskills}
...
\begin{projects}
    ...
    \project {TwitterScraper \textit{(22 stars)}}

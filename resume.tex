...
\geometry{left=0.65in, right=0.65in, top=0.5in, bottom=0.54in, footskip=0.15in}
\hyphenpenalty=10000
...
%%%%%%%% COMMANDS
\newcommand{\col}{awesome-darknight}
...
\begin{technicalskills}
    \techskill{\regcol{Languages}}{
        Python, \ R, \ C++, \ Scala, \ Java, \ SQL (Oracle), \ Shell (BASH)
    }
    \techskill{\regcol{Technology}}{
        Scikit-Learn, \ Tidyverse, \ AWS, \ Git, \ Docker, \ Linux%, \ HTCondor, \ Jupyter, \ Latex
    }
    \techskill{\regcol{Frameworks}}{
        Hadoop, \ Spark, \ Flask, \ Boto3 (AWS SDK)
    }
\end{technicalskills}

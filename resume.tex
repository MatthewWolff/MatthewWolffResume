...
\begin{technicalskills}
    \techskill{\regcol{Languages}}{
        Python, \ R, \ SQL (\textit{MySQL}), \ Scala, \ Shell Script (BASH), \ Java
    }
    \techskill{\regcol{Frameworks}}{
        Spark, \ Boto3, \ Pytorch, \ Hadoop, \ Keras, \ Flask
    }
    \techskill{\regcol{Technology}}{
        AWS (\textit{EC2, S3, Lambda}), \ Git, \ Jupyter, \ Postman, \ LaTeX, \ Linux%, \ HTCondor
    }
\end{technicalskills}
